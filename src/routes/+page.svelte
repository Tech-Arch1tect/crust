...
<div class="mx-auto max-w-4xl">
	...
	<div class="mb-16 grid grid-cols-1 gap-6 md:grid-cols-3">
		<StatsCard value={meta?.posts?.total} label="Published Posts" colour="blue" />
		<StatsCard value={meta?.categories?.total} label="Categories" colour="emerald" />
		<StatsCard value={meta?.tags?.total} label="Tags" colour="purple" />
	</div>
